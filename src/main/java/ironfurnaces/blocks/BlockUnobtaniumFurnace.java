...
import ironfurnaces.tileentity.BlockUnobtaniumFurnaceTile;
...
public class BlockUnobtaniumFurnace extends BlockIronFurnaceBase {
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new BlockUnobtaniumFurnaceTile();
    }
}
